<a class="provider clearfix" href="<?php echo $this->action('profile', $personnelObj->getPersonnelID()); ?>" data-provider="<?php echo implode(',', $personnelObj->getProviderLocations()); ?>" data-name="<?php echo "{$personnelObj->getFirstName()} {$personnelObj->getLastName()}"; ?>">
	...
	<em><?php echo $personnelObj->getProviderLocations(true); ?></em>
</a>